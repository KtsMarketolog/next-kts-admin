...
import {
  BRAND_LOGO_SIZE_PENDING,
  formatFileSize,
  useBrandLogoSizes,
} from './useBrandLogoSizes';
...
export function AdminBrandPortfolioSection({
  ...
  const { brandLogoSizes, brandDraftLogoSize, setBrandDraftLogoSize, setSavedBrandLogoSize } = useBrandLogoSizes({
    brands,
    draftImageUrl: brandDraft.imageUrl,
  });
                ...
                <AdminImagePicker
                  ...
                  onUpload={(file) =>
                    uploadLogo(file, (url) => {
                      ...
                      setSavedBrandLogoSize(brand.id, url, formatFileSize(file.size));
                    })
                  }
                />
                {brand.imageUrl ? (
